...
import {MotorCommands, MotorCommandsDictionary} from '../../servo-engine/motor-commands'

const Tutorial: NextPageWithLayout = () => {
  const [currentChapter, setCurrentChapter] = useState(1)
  const [currentCommandDictionary, setCurrentCommandDictionary] = useState<MotorCommandsDictionary>(MotorCommands[0]);
