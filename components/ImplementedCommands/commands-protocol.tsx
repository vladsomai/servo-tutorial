      ...
      <div className="flex flex-col justify-center items-center">
        <div className="w-8/12">
          <article className="mb-5 prose prose-slate max-w-full">
            ...
            <ul>
              ...
              <li>
                ...
                <b>
                  ...
                  parameters are needed, you must specify the Third byte as
                  0x00.
                </b>
              </li>
              <li>
                ...
                <b>
                  Do not worry,&nbsp; we will explain what arguments each
                  command needs so you can construct your own raw commands.
                </b>
              </li>
            </ul>
            ...
            <ul>
              <li>
                First byte: Represents a reserved axis byte for the received
                messages. This byte is currently set to ASCII &quot;R&quot;.
              </li>
              <li>
                Second byte: Represents the status of the sent command.
                <br></br>0 indicates success and no payload shall be received.
                <br></br>1 indicates there are one or more parameters received.
              </li>
              <li>
                Third byte: Represents the length of the payload bytes. Each
                command has different response payloads.
              </li>
              <li>
                The rest of the bytes will represent the payload the command
                responded with.
              </li>
            </ul>
          </article>
          <article className="mb-10 prose prose-slate max-w-full">
            ...
            <ul>
              ...
              <li>
                The SI unit for an angle is the <strong>radian</strong>.
                <br></br>
            ...
            <ul>
              ...
              <li>
                The internal unit for velocity can be understood as the number
                of
              ...
              <li>
                The SI unit is <strong>radians per second</strong>.<br></br>{' '}
              ...
              <li>
                ...
                send the velocity in <strong> communication units</strong> and
              ...
              <li>
                The conversion is as follows:
                <br></br>
                velocity_internal = velocity_radians_per_second / 2 / PI *
                645120 / 31250 * 2^32
                <br></br>
                velocity_internal = velocity_rotations_per_second * 645120 /
                31250 * 2^32
                <br></br>
            ...
            <ul>
              ...
              <li>
                ...
                to send the acceleration in{' '}
                <strong> communication units</strong> and the motor will
                self-convert it to internal units.
              </li>
              ...
              <li>
                ...
                acceleration_rotations_per_second_squared * 645120 / 31250^2 *
                2^32
                <br></br>
                acceleration_internal =
                acceleration_rotations_per_minute_squared / 60^2 * 645120 /
                31250^2 * 2^32
                <br></br>
