...
if len(ping_text)!=10:
    print("You must input exactly 10 characters!")
    exit()

# Format of the command: uchar, uchar, uchar, int, uint
# Reference: https://docs.python.org/3/library/struct.html#format-characters
command_format = '<BBB10s'
bytes = struct.pack(command_format, alias, motor_command, motor_command_length, ping_text.encode())
