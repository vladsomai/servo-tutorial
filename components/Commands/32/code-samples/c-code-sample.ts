...
int main(int argc, char* argv[])
{
    ...
    uint8_t alias = 255;
    uint8_t motor_command = 32;
#define motor_command_length 1
    uint8_t turn_on_off_gathering = 0;

#define alias_cmd_len 3
    uint8_t cmd[alias_cmd_len + motor_command_length] = { alias, motor_command, motor_command_length, turn_on_off_gathering };
