...
int main(int argc, char* argv[])
{
    ...
    uint8_t alias = 255;
    uint8_t motor_command = 7;
#define motor_command_length 1
    uint8_t data_to_capture = 0;

#define alias_cmd_len 3
    uint8_t cmd[alias_cmd_len + motor_command_length] = { alias, motor_command, motor_command_length, data_to_capture };
