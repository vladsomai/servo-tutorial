 ...
 */
function get6BytesFromNumber(number) {
    const maxIndex = 6
    const viewBytes = new DataView(new ArrayBuffer(8));

    viewBytes.setBigUint64(0, BigInt(number), true);

    let result = new Uint8Array(maxIndex);
